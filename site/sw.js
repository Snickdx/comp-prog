const CACHE_NAME = 'tech-guide-vmgf7shy3-hvyrse';
const STATIC_CACHE_URLS = [
  ...
  "/assets/images/screenshots/screenshot-narrow.png",
  "/assets/images/screenshots/screenshot-wide.png",
...
self.addEventListener('install', event => {
  console.log('Service Worker: Installing version vmgf7shy3-hvyrse...');
  event.waitUntil(
    caches.open(CACHE_NAME)
      .then(cache => {
        console.log('Service Worker: Caching 102 static resources');
...
self.addEventListener('activate', event => {
  console.log('Service Worker: Activating version vmgf7shy3-hvyrse...');
  event.waitUntil(
    caches.keys()
      .then(cacheNames => {
        return Promise.all(
...
// Service Worker version: vmgf7shy3-hvyrse
// Generated on: 2025-10-06T14:16:47.154Z
// Cached files: 102